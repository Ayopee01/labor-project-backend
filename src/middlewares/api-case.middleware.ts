...
const requestKeyMap: Record<string, string> = {
  ...
  CorrectedByWorkerCode: "corrected_by_worker_code",
  ...
  SubmittedWorkerCodes: "submitted_worker_codes",
  ...
  VendorConfirmedCompleteAt: "vendor_confirmed_complete_at",
  ...
  FinancializedAt: "financialized_at",

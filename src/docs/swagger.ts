...
function sortSwaggerOperations(
  ...
  const operationOrder: Record<string, number> = {
    ...
    "get /api/admin/vehicle-jobs/history": 30,
    "post /api/admin/vehicle-jobs/{vehicleJobRef}/assign-workers": 32,
    "post /api/admin/vehicle-jobs/{vehicleJobRef}/scan-deadline/extend": 33,
    "post /api/admin/vehicle-jobs/{vehicleJobRef}/workers/{workerCode}/assignment/cancel": 34,

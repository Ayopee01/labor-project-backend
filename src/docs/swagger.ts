...
function sortSwaggerOperations(
  ...
  const operationOrder: Record<string, number> = {
    ...
    "get /api/admin/users/{workerCode}": 21,
    "post /api/admin/users": 22,
    "patch /api/admin/users/{workerCode}": 23,
    "patch /api/admin/users/{workerCode}/password": 24,
    "get /api/admin/jobs/workers/status": 26,
    "post /api/admin/jobs/workers/{workerCode}/status/force": 28,

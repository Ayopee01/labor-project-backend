...
export async function createVehicleJobFromGate(
  ...
  // Function lock VehicleJob ก่อนสร้างหรือ append Business Ticket
  ...
  // Function เปิด dispatch คืนเมื่อ Gate เพิ่ม booth หลัง release-workers
  ...
  let savedMarket;
  // Function re-check MarketJob หลัง lock ก่อน append
  ...
  // Function ปิดรับ Ticket เพิ่มหลัง Gate create สำเร็จ

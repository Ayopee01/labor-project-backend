...
import {
  removeMobileAppForceUpdateNotification,
  removeMobileAppReleaseNotification,
  scheduleMobileAppForceUpdateNotification,
  scheduleMobileAppReleaseNotification,
} from "../../queues/worker-queue";

// Import Types
import type {
  MobileAppVersionCreateInput,
  MobileAppVersionDto,
  MobileAppVersionStatus,
  MobileAppVersionUpdateInput,
} from "../../types/shared/mobile-app-version.type";

// Import Validation
import { parseId, parseWithSchema } from "../../validation/parser";
import {
  createMobileAppVersionBodySchema,
  mobileAppVersionCheckQuerySchema,
  updateMobileAppVersionBodySchema,
...
export function resolveEffectiveMobileAppVersion(
